 ...
 * callback my_demo_ajax_call, which was added within the Fcf_Pay_Run class.
 ...
 * 
 * You can add the localized variables in here as followed: fcfpay.plugin_name
 * These variables are defined within the localization function in the following file:
 * core/includes/classes/class-fcf-pay-run.php
 * 
 * HELPER COMMENT END
 */
    ...
    $(document).ready( function() {
        $.ajax({
            ...
            data : {
                ...
                demo_data : 'test_data', 
                ajax_nonce_parameter: fcfpay.security_nonce
            },
